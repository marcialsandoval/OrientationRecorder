...
OrientationRecorder is an android app which goal is to determine the mobile phones orientation by using the devices inercial sensors (accelerometer and magnetometer), but also to record this sensor readings including the apps outcome into a .csv file. 
